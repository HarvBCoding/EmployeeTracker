...
CREATE TABLE manager (
    ...
    CONSTRAINT mn_role FOREIGN KEY (roleId) REFERENCES role(id) ON DELETE CASCADE
);
...
CREATE TABLE employee (
    ...
    CONSTRAINT fk_manager FOREIGN KEY (managerId) REFERENCES manager(id) ON DELETE CASCADE
);